...
<img src="/images/chains/zkSync.png" alt="Scroll zk-EVM L2" style={{"width":"300px", margin: "0px auto;", marginTop: "20px"}} />
...
The [context](/concepts#context) for zkSync is the last submitted batch number which is fetched by calling `getTotalBatchesExecuted` on the rollup contract.
