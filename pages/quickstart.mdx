...
First checkout the repo: `https://github.com/unruggable-labs/evmgateway-v2.git`

## Deploy a data contract

This contract gets deployed to the L2 blockchain of your choice.
...
contract SimpleResolver is EVMFetchTarget {
