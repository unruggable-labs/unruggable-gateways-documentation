...
- To verify that your name is resolving appropriately type the name into the [ENS Whois](https://ethtools.com/ens-whois) tool and verify the output of the lookup.
...
[These examples](https://github.com/unruggable-labs/unruggable-gateways-op-stack-ens-resolution-demo) demonstrates full end to end resolution using Unruggable Gateways.
